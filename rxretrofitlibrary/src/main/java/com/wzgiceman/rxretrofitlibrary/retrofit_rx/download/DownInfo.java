...
public class DownInfo {
    ...
    public DownInfo(String url, @NonNull File outFile) {
        setUrl(url);
        setSavePath(outFile.getAbsolutePath());
    ...
    public String getSavePath() {
        Log.e("DownInfo", "getSavePath = " + savePath);
        return savePath;
    }
    ...
    public boolean isSameDownloadUrl(DownInfo downInfo) {
        return downInfo == null ? false : TextUtils.equals(getUrl(), downInfo.getUrl());
    }

    public boolean isSameSavePath(DownInfo downInfo) {
        return downInfo == null ? false : TextUtils.equals(getSavePath(), downInfo.getSavePath());
    }
